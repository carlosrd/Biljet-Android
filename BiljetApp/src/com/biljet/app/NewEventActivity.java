...
public class NewEventActivity extends ActivitiesHeader {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //Oyente para cambiar las imagenes, mas adelante utulizaremos el metodo para acceder a la galeria de imagemes.
   ...
   @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            picturePathG = cursor.getString(columnIndex);
            cursor.close();
    ...
    /**Method that creates a new event with the data entered by the user.
     * 
     * @param view
     */   
    @SuppressLint("NewApi")
   ...
   //EL ID del evento sera el n-esimo evento organizado por el usuario.
