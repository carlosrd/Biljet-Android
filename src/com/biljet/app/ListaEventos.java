...
public class ListaEventos{
	...
	public ListaEventos(){
		...
		Evento evento3 = new Evento("Cumpleaños Hugo",3 ,drawable.jessie_j_evento ,"Fiesta", "Sevilla", new Fecha(15,2,2013,19,45), 5, 10, 20, "Hugo", "Celebro mi cumpleaños en mi casa, vente!", 3);
		Evento evento4 = new Evento("Cine Forum",4 ,drawable.jessie_j_evento ,"Cine", "Madrid", new Fecha(24,12,2012,21,00), 3, 10, 5, "ONG", "Película: Navidad, en Madrid a las 21:00 ¿La has visto? Coméntala", 7);
